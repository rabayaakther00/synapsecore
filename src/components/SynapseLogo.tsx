  ...
  return (
    <div className={`flex items-center gap-2.5 font-bold tracking-tight text-white select-none ${className}`}>
      ...
      <div className={`relative ${iconSizes[size]} shrink-0 transition-transform duration-200 hover:scale-105`}>
        ...
        >
          <defs>
            <linearGradient id="synapseTechIndigo" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <linearGradient id="synapseCyanAccent" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <path
            ...
            fill="url(#synapseTechIndigo)"
          />
          {/* Inner chrome/cyan core facet */}
          <path
      ...
      {showText && (
        <span className={`font-bold tracking-tight ${textSizes[size]} text-white flex items-center`}>
          <span>Synapse</span>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-violet-300 to-cyan-400 ml-0.5">Core</span>
        </span>
      )}
    </div>
  );
